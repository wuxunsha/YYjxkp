      ...
      <Row class="from-content">
        <Tabs :animated="false" class="tabs" value="name1">
          ...
          <TabPane label="反馈与批示" name="name2" class="tabs2">
            ...
            <Row>
              <Button class="add-feedback" @click="submit" v-if="btnShow(123101107)">提交反馈</Button>
            </Row>
    ...
    getPySumDataList () {
      getPySumDet(this.$route.query.id).then(res => {
        if (res.data.code === 10000) {
          this.pySumList = res.data.data.pageData
