        ...
        <div class="content">
          ...
          <TabPane label="考核结果" name="name1">
            <Row class="modify-submit">
                <Button type="primary" @click="submitDataPerformance" v-if="btnShow(112102105102)" >提交</Button>
            </Row>
            <Row>
...
<script>
import { getDataCheckLists, submitPerformance, processSubmission } from '@/api/performance-appraisals'
  ...
  methods: {
    ...
    operation () {
      return (h, params) => {
        ...
        return h('div', [this.btnShow(112102105101) && detailTooltip])
      }
    },
    detailData (params) {
      this.$router.push({
