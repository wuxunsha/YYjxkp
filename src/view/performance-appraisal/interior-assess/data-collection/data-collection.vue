          ...
          <Tabs class="tabs">
            <TabPane label="考核指标" class="tabs1">
              ...
              <Row class="submit-box">
                <Col span="24">
                  <Button type="primary" class="submit-btn" @click="submit" v-if="btnShow(112102103102)">
                    <i class="icon-font icontijiao"></i>
                    提交给被考核单位</Button>
                </Col>
              </Row>
              <!-- 表格数据 -->
            ...
            <TabPane label="反馈与评论" class="tabs2">
              ...
              <Row>
                <Button class="add-feedback" @click="submitFeedback">提交反馈</Button>
              </Row>
              <!-- 已反馈内容 -->
              <Row class="footer">
...
<script>
import {
  getloginperfomancebatchnodesinfopeer,
  ...
  methods: {
    operation () {
      return (h, params) => {
        ...
        return h('div', [this.btnShow(112102103101) && detailTooltip])
      }
    },
    detailData (params) {
      this.$router.push({
    ...
    getloginperfomancebatchnodesinfoupList () {
      getloginperfomancebatchnodesinfopeer(2).then(res => {
