          ...
          <Form :model="assessData">
            ...
            <FormItem class="assess-time">
              <Row>
                ...
                <Col span="4">
                  <DatePicker type="datetime" format="yyyy-MM-dd HH" transfer placeholder="开始时间" @on-change="startTimeChange"></DatePicker>
                </Col>
                <Col span="1" >
                  <span>~</span>
                </Col>
                <Col span="4">
                  <DatePicker type="datetime" format="yyyy-MM-dd HH" transfer placeholder="截止时间" @on-change="endTimeChange"></DatePicker>
                </Col>
              </Row>
            </FormItem>
            <!-- 时间节点设置 -->
