...
<script>
import {
  getloginperfomancebatchnodesstatuepeer
...
export default {
  ...
  created () {
    ...
    this.getloginperfomancebatchnodesstatuepeerData()
  },
  mounted () {
  },
  methods: {
    // 获取当前登录用户本级绩效考核每一个节点是否有操作权限
    getloginperfomancebatchnodesstatuepeerData () {
      getloginperfomancebatchnodesstatuepeer().then(res => {
