        ...
        <div class="content">
          ...
          <TabPane label="考核结果" name="name1">
            <Row class="download-release">
                ...
                <Button type="primary" icon="ios-search" @click="confirmRelease" v-if="btnShow(112101106102)" >确认并发布</Button>
            </Row>
            <Row>
...
<script>
import { getDataCheckList, resultRelease, resultScore, processSubmission } from '@/api/performance-appraisals'
  ...
  methods: {
    ...
    operation () {
      return (h, params) => {
        ...
        return h('div', [this.btnShow(112101106101) && detailTooltip, modifyTooltip])
      }
    },
